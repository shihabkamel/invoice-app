...
<div class="container">
    <div class="invoices">
            ...
            <div class="card__content">
                ...
                <div class="table__footer">
                    <div class="document-footer" >
                        ...
                        <textarea cols="50" rows="7" class="textarea" v-model="form.temrs_and_condition"></textarea>
                    </div>
                    <div>
        ...
        <li v-for="(item, i) in listproducts" :key="item.id" style="display: grid; grid-template-columns: 30px 350px 15px; align-items: center; padding-bottom: 50px;">
                                <p>
                                    {{ i + 1 }}
                                </p>
                                <a href="#">{{ item.item_code }}{{ item.description }}</a>
                                <button @click="addCart(item)" style="border:1px solid black; width: 35px;height: 35px;cursor: pointer;;">+</button>
                            </li>
                        </ul>
                </div>
                <br><hr>
